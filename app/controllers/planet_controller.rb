...
class PlanetController < ApplicationController
  ...
  # Método que implementa la busqueda de sitios y viajes. Es necesario que la cadena de busqueda tenga una longitud mayor de 3 caracteres.
  def search
