class ComentariosController < ApplicationController
  ...
  def new
    @comentario = current_user.comentarios.build # crea sitio vacio asociado a current_user
  ...
  def create
    @comentario = current_user.comentarios.build(params[:comentario]) # Asigna solo si sitio asociado a current_user
